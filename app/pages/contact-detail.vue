    ...
    <main>
      ...
      <section class="page-hero">
        ...
        <div class="page-hero__inner">
          <div class="chip chip--teal"><div class="chip__dot"></div>Hubungi Kami</div>
          <h1 class="sec-h sec-h--lg sec-h--white">Informasi Kontak DKN Indonesia</h1>
          <p class="sec-sub sec-sub--white mt-16">
            Kami siap membantu — baik untuk pertanyaan tentang program, konsultasi corporate,
      ...
      <section class="section bg--mist">
        <div class="wrap">
          <span class="sec-label">Informasi Kontak</span>
          <h2 class="sec-h">Cara Menghubungi Kami</h2>
          <p class="sec-sub">Pilih cara yang paling nyaman bagi Anda. Kami merespons semua saluran komunikasi dalam jam kerja.</p>
          ...
          <div class="contact-info-grid">
            ...
            <div class="contact-info-tile">
              ...
              <div>
                ...
                <div class="contact-info-tile__value">Senin – Jumat</div>
                <div class="contact-info-tile__note">08.00 – 17.00 WIB<br>Sabtu – Minggu: Libur (respons WA mungkin terbatas)</div>
              </div>
            </div>
          ...
          <div style="margin-top:36px">
            ...
            <div class="social-row">
              ...
              <a href="#" class="social-link-card" target="_blank" rel="noopener">
                <div class="social-link-card__ico" style="background:#FF0000">
                  <svg viewBox="0 0 24 24" fill="white"><path d="M22.54 6.42a2.78 2.78 0 00-1.94-1.96C18.88 4 12 4 12 4s-6.88 0-8.6.46a2.78 2.78 0 00-1.94 1.96A29 29 0 001 12a29 29 0 00.46 5.58A2.78 2.78 0 003.4 19.54C5.12 20 12 20 12 20s6.88 0 8.6-.46a2.78 2.78 0 001.94-1.96A29 29 0 0023 12a29 29 0 00-.46-5.58z"/><polygon points="9.75 15.02 15.5 12 9.75 8.98 9.75 15.02" fill="#FF0000"/></svg>
                </div>
                <div>
                  <h4>YouTube</h4>
                  <p>DKN Indonesia</p>
      ...
      <!-- ═══ SECTION 3: MAP / LOKASI ═══ -->
      <section class="section bg--white">
        <div class="wrap">
          <span class="sec-label">Lokasi Kami</span>
          <h2 class="sec-h">Temukan Kantor DKN Indonesia</h2>
          ...
          <!-- Quick FAQ about visiting -->
          <div class="faq-list">
            <div class="faq-item">
              <h4>Apakah bisa berkunjung langsung ke kantor?</h4>
              <p>Ya, kunjungan langsung dipersilakan dengan janji sebelumnya. Hubungi kami via WhatsApp minimal satu hari kerja sebelumnya untuk mengatur jadwal pertemuan.</p>
            </div>
            <div class="faq-item">
              <h4>Apakah ada parkir di kantor?</h4>
              <p>Tersedia area parkir terbatas di gedung. Kami rekomendasikan menggunakan transportasi umum (KRL, MRT, Transjakarta) atau layanan ride-hailing untuk kemudahan akses.</p>
            </div>
            <div class="faq-item">
              <h4>Bisakah konsultasi dilakukan secara online/virtual?</h4>
              <p>Tentu saja. Sebagian besar konsultasi dan discovery call dilakukan melalui Zoom atau Google Meet. Hubungi kami dan kami akan mengatur sesi virtual yang sesuai jadwal Anda.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <!-- ═══ SECTION 4: CTA KONSULTASI ═══ -->
      <section class="section bg--mist">
        <div class="wrap">
          <div class="konsultasi-cta">
            <div>
              <h2>Siap Mendiskusikan Kebutuhan<br><em>Pelatihan Organisasi Anda?</em></h2>
...
.contact-info-tile__ico {
  width: 52px; height: 52px;
  border-radius: 12px;
  display: flex; align-items: center; justify-content: center;
  flex-shrink: 0;
}
.contact-info-tile__ico svg { width: 24px; height: 24px; }
.contact-info-tile h3 { font-size: 13px; font-weight: 700; text-transform: uppercase; letter-spacing: .6px; color: var(--slate); margin-bottom: 8px; }
.contact-info-tile__value { font-size: 16px; font-weight: 700; color: var(--ink); line-height: 1.5; }
.contact-info-tile__value a { color: var(--teal2); text-decoration: none; }
.contact-info-tile__value a:hover { text-decoration: underline; }
.contact-info-tile__note { font-size: 13px; color: var(--slate); margin-top: 4px; line-height: 1.55; }
...
.social-link-card:hover { transform: translateY(-2px); box-shadow: var(--shadow-h); }
.social-link-card__ico {
  width: 40px; height: 40px; border-radius: 10px;
  display: flex; align-items: center; justify-content: center;
  flex-shrink: 0;
}
.social-link-card__ico svg { width: 20px; height: 20px; }
.social-link-card h4 { font-size: 14px; font-weight: 700; color: var(--ink); margin-bottom: 2px; }
.social-link-card p { font-size: 12px; color: var(--slate); }
...
.map-overlay-card {
  ...
  border-radius: var(--r-lg);
  padding: 18px 22px;
  box-shadow: 0 4px 24px rgba(20,34,56,.14);
  max-width: 280px;
}
.map-overlay-card h4 { font-size: 14px; font-weight: 700; color: var(--ink); margin-bottom: 5px; }
.map-overlay-card p { font-size: 13px; color: var(--slate); line-height: 1.55; margin-bottom: 12px; }
...
.faq-item h4 { font-size: 14.5px; font-weight: 700; color: var(--ink); margin-bottom: 6px; }
.faq-item p { font-size: 13.5px; color: var(--slate); line-height: 1.6; }
...
.konsultasi-cta h2 { font-family: var(--serif); font-size: 34px; color: #fff; font-weight: 600; line-height: 1.2; margin-bottom: 10px; }
.konsultasi-cta h2 em { color: var(--gold2); font-style: italic; }
.konsultasi-cta p { font-size: 15px; color: rgba(255,255,255,.52); line-height: 1.7; font-weight: 300; }
.konsultasi-cta__right { display: flex; flex-direction: column; gap: 12px; align-items: flex-end; }
.konsultasi-cta__note { font-size: 12px; color: rgba(255,255,255,.28); display: flex; align-items: center; gap: 5px; }
.konsultasi-cta__note svg { width: 12px; height: 12px; }

@media (max-width: 900px) {
  .contact-info-grid { grid-template-columns: 1fr; }
  .social-row { grid-template-columns: 1fr; }
  .konsultasi-cta { grid-template-columns: 1fr; }
  .konsultasi-cta__right { align-items: flex-start; }
  .map-overlay-card { position: static; margin: 0 16px 16px; max-width: 100%; }
